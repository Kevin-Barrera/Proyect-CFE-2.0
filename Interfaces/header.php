...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="inicio.php?idTrabajador=<?php echo $idTrabajador; ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="inicio.php?idTrabajador=<?php echo $idTrabajador; ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="proyectos.php?idTrabajador=<?php echo $idTrabajador; ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="reportes.php?idTrabajador=<?php echo $idTrabajador; ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="trabajadores.php?idTrabajador=<?php echo $idTrabajador; ?>">
